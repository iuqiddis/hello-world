function [RE,IM,NP,NB,NT,HDR] = varianloadfid(name,blocks,traces);
%----------------------------------------
%function load_fid
...
% format input name
%fullname = sprintf('%s.fid%cfid',name,'\'); % for Unix-based systems (Linux, Mac OS X, etc.) the file separator has to be '/'
fullname = sprintf('%s.fid%cfid',name,'/'); % for Unix-based systems (Linux, Mac OS X, etc.) the file separator has to be '/'
